...
- pack/fixtures/socratic_discovery_v0/README.md
- pack/verification_plan.md
- pack/traceability_matrix.md

## Changes Made
- Added fixture plan for category-specific discovery, answer capture, hypotheses, and stop conditions.
- Added verification plan with V1 and V2 checks.
- Added traceability from requirements to risks and verification checks.

## Assumptions
- Future implementation will use deterministic local tests rather than live model or integration proof.
