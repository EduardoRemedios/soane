...
- `pack/SPRINT_20260718_001_ENVELOPE_REDTEAM.md`
- `pack/SPRINT_20260718_001_ENVELOPE.md`
## Changes Made
- Added hard ceilings, numeric defaults, path identity, and one-pass inbound indexing.
## Assumptions
...
- None
### NON-BLOCKING
- Exact code identifiers remain implementation choices.
## Verification Steps Recommended
- Consolidate the completed pack for I2.
