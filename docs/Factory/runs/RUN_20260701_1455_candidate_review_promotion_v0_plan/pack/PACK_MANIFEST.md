...
- v1 (2026-07-01): Initial Stage J manifest.
- v2 (2026-07-01): Updated after Stage I2 audit.

## Run Metadata

- RUN_ID: RUN_20260701_1455_candidate_review_promotion_v0_plan
- Sprint ID: CRP-V0-001
- Created: 2026-07-01 14:55 local
- Execution Mode: PLANNING_ONLY
- Spec Versions: STAGE_CONTRACTS v4.13, PURPLE_GATE_CHECKLIST v3.3

## Required Run Root Files

- raw_brief.md: present
...
- intent.md: present
- intent_redteam.md: present
- intent_synthesis.md: present
- intent_lock_report.md: present
...
- CRP-V0-001_ENVELOPE.md: present
- CRP-V0-001_ENVELOPE_REDTEAM.md: present
- fixtures/: present
- PACK_CHECKLIST.md: present
- PACK_MANIFEST.md: present
- PACK_AUDIT_REPORT.md: present
...
All required run-root, pack, envelope, fixture, gate, and handoff artifacts are present for final pack lint.
